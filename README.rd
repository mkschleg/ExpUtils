...
After working in machine learning and reinforcement learning research for a year now, and in upper level computer science research/study for a few years, I have found the need to create a library containing various utilities to make research and experimentation using c++ easier. The need arose from the disparity between the compiler on my preferred servers and personal computer, and many hours debugging compiler differences. Instead of each project having to manage this issue for basic functionality this library will be unix specific for c++11 and up and will hopefully mitigate this issue.
